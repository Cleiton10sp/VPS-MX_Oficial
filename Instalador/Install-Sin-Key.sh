...
v1=$(curl -sSL "https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/Version")
...
repo() {
  link="https://raw.githubusercontent.com/Cleiton10sp/Multi-Script/main/Source-List/$1.list"
  case $1 in
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/Instalador/Install-Sin-Key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
install_continue() {
  ...
  tput cuu1 && tput dl1
  msg -bar
  print_center -ama "Se algumas das dependências falharem!!!\nal terminar, finalmente, você pode tentar instalar\nit manualmente usando o seguinte comando\napt install package_name"
  msg -bar
...
install_oficial() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/VPS-MX.tar.xz >/dev/null 2>&1
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.4g%20Oficial/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'mess1="$(less /etc/VPS-MX/message.txt)" ' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[92m𝔽𝕌𝕃𝕃 𝕊ℂℝ𝕀ℙ𝕋 : $mess1 "' >>.bashrc
  echo 'echo -e "\t\e[1;33m𝔽𝕌𝕃𝕃: \e[1;31m$(cat /etc/versin_script_new)"' >>.bashrc
  echo 'echo "" ' >>.bashrc
...
install_mod() {
  ...
  mkdir /etc/VPS-MX >/dev/null 2>&1
  cd /etc
  wget https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/VPS-MX.tar.xz >/dev/null 2>&1
  tar -xf VPS-MX.tar.xz >/dev/null 2>&1
  chmod +x VPS-MX.tar.xz >/dev/null 2>&1
  rm -rf VPS-MX.tar.xz
  cd
  ...
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version &>/dev/null
  echo '#!/bin/sh -e' >/etc/rc.local
  sudo chmod +x /etc/rc.local
  ...
  echo 'echo -e "\t\033[91m   \ V / |  __/ ___) |_____| |  | |/  \  " ' >>.bashrc
  echo 'echo -e "\t\033[91m    \_/  |_|   |____/      |_|  |_/_/\_\ " ' >>.bashrc
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/SCRIPT-v8.5x%20Mod/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'mess1="$(less /etc/VPS-MX/message.txt)" ' >>.bashrc
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[92m𝔽𝕌𝕃𝕃 𝕊ℂℝ𝕀ℙ𝕋 : $mess1 "' >>.bashrc
...
install_ADMRufu() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Cleiton10sp/Multi-Script/main/R9/ADMRufu.tar.xz >/dev/null 2>&1
...
install_ChumoGH() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Cleiton10sp/Multi-Script/main/ChuG/adm-lite.tar.xz >/dev/null 2>&1
  ...
  wget -q -O /bin/toolmain https://raw.githubusercontent.com/Cleiton10sp/Multi-Script/main/ChuG/utilitarios/toolmain
  chmod +x /bin/toolmain
  echo 'source <(curl -sSL https://raw.githubusercontent.com/Cleiton10sp/Multi-Script/main/ChuG/utilitarios/free-men.sh)' >/bin/ejecutar/echo-ram.sh
  echo 'wget -q -O /bin/ejecutar/v-new.log https://raw.githubusercontent.com/Cleiton10sp/Multi-Script/main/ChuG/utilitarios/v-new.log' >>/bin/ejecutar/echo-ram.sh && bash /bin/ejecutar/echo-ram.sh
