...
msg -bar
msg -tit
echo -e "${cor[3]}    INSTALADOR SHADOWSOCK-R+(obfs) By @Cleiton10sp"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
