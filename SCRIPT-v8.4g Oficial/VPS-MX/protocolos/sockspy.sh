...
cd socks
patch="https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/backsocz.zip"
arq="backsocz.zip"
...
gettunel_fun () {
echo "main=Cleiton10sp" > ${SCPinst}/pwd.pwd
...
msg -bar 
msg -tit
msg -ama "   INSTALADOR DE PROXY'S VPS-MX By MOD @Cleiton10sp"
msg -bar
