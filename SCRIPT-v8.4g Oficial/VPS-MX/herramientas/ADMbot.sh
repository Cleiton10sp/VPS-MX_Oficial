...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/Cleiton10sp/VPS-MX_Oficial/main/LINKS-LIBRERIAS/ShellBot.sh &> /dev/null
...
msg -bar
msg -tit
msg -ama "      ## BOT DE GESTION | VPS-MX By @Cleiton10sp ## \033[1;31m"
msg -bar
...
local bot_retorno="*$LINE*\n"
		  ...
		  bot_retorno+="*$LINE*\n"
          bot_retorno+="_Ejemplo: /SSHI Cleiton10sp-xzcmo _\n"
          bot_retorno+="*$LINE*\n"
	      ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
							--text "$(echo -e $bot_retorno)" \
							--parse_mode markdown
